...
$informa = visuUsuarioCodigo($conexao, $codigousu);


?>

<div class="container">
<form class="row g-3" action="../controller/alterarUsuario.php" method="post">
  ...
  <div class="col-md-4">
    ...
    <select id="inputTipo" name="tipousu" class="form-select">
      <option selected value="<?=$informa["ativiusu"]?>">
      
      <?php
      if($informa["ativiusu"] == "1")
      echo("Funcionário");
        else
      echo("Cliente");
      ?>
