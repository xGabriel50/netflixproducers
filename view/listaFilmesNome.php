...
<form action="listaFilmesNome.php" method="POST">
    <div class="row mb-3">
        <label for="inputNome" class="col-sm-2 col-form-label">Digite o Nome do Filme: </label>
        <div class="col-sm-3">
            <input type="text" name="nomeFil" class="form-control" id="inputNome" required>
        </div>
        <div class="col-sm-3">
...
<table class="table text-light">
    ...
    <tbody>
        <?php
        $nomeFil = isset($_POST['nomeFil'])?$_POST['nomeFil']:"";
        if($nomeFil!=""){
            $filme = listaFilmesNome($conexao,$nomeFil);
